...
# FIXED VERSION - without hddtemp dependency (now same as main install.sh)
# Usage: bash -c "$(curl -fsSL https://raw.githubusercontent.com/lookatitude/homelab/main/proxmox/ipmi/install-fixed.sh)"
